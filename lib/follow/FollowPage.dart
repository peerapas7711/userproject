...
import 'package:userproject/model/FollowMember.dart';
...
class _FollowPageState extends State<FollowPage> {
  List<Showactivityfollow> activitymember = [];
  var uId;
  var token;
  ...
  Future<Void> _getUsAc() async {
    ...
    print('token = $token');
    // print('acId = $acId');
    var url = '${Connectapi().domain}/followuseractivity/$uId';
    //conect
    ...
    if (response.statusCode == 200) {
      FollowMember member =
          FollowMember.fromJson(convert.jsonDecode(response.body));

      setState(() {
        activitymember = member.showactivityfollow;
      });
    }
  }
            ...
            : GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    onTap: () {
                      Navigator.pushNamed(context, '/showfollowac', arguments: {
                        'fl_id': activitymember[index].flId,
