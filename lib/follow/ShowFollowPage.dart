...
class ShowFollowPage extends StatefulWidget {
  @override
  _ShowFollowPageState createState() => _ShowFollowPageState();
}

class _ShowFollowPageState extends State<ShowFollowPage> {
  ...
  Future<void> _cancelFollowAc() async {
    var url = '${Connectapi().domain}/cancelfollowac/$_acId';
    // print(_joinId);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        //     ),
        //     onPressed: () {
        //       Navigator.pop(context, '/followac');
        //      _cancelFollowAc();
        //       _showberlike();
        //     },
        //   ),
                                        ...
                                        children: [
                                          ...
                                          SizedBox(
                                            ...
                                            child: RaisedButton(
                                              ...
                                              onPressed: () {
                                                Navigator.pushNamed(context, '/showuserjoinall',arguments: {
                                                  '_acId': _acId,
                                                });
                                              },
                                            ),
