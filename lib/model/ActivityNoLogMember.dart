// class ActivityNoLogMember {
//   bool ok;
//   List<Rowsnolog> rowsnolog;

//   ActivityNoLogMember({this.ok, this.rowsnolog});

//   ActivityNoLogMember.fromJson(Map<String, dynamic> json) {
//     ok = json['ok'];
//     if (json['rowsnolog'] != null) {
//       rowsnolog = new List<Rowsnolog>();
//       json['rowsnolog'].forEach((v) {
//         rowsnolog.add(new Rowsnolog.fromJson(v));
//       });
//     }
//   }
...
//     data['ok'] = this.ok;
//     if (this.rowsnolog != null) {
//       data['rowsnolog'] = this.rowsnolog.map((v) => v.toJson()).toList();
//     }
//     return data;
//   }
// }
...
//   Rowsnolog.fromJson(Map<String, dynamic> json) {
//     acId = json['ac_id'];
//     acName = json['ac_name'];
//     acType = json['ac_type'];
//     acTime = json['ac_time'];
