...
class ShowJoinActivity extends StatefulWidget {
  @override
  _ShowJoinActivityState createState() => _ShowJoinActivityState();
}

class _ShowJoinActivityState extends State<ShowJoinActivity> {
              ...
              builder: (_) => AlertDialog(
                    title: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text('คุณต้องการยกเลิกการเข้ากิจกรรม !!!',style: TextStyle(fontSize: 16),),
                        ),
                      ],
                    ),
                    actions: <Widget>[
